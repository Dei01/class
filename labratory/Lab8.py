...
# list1 = ["A", "B", "C"] жагсаалт үүсгэ. 
# a) List2 = list1, list3 = list2 утга олго. 
# b) List1 ба List2-ийн 0 индекстэй элементүүдийг тус бүр устга. 
# c) List3 жагсаалтыг хэвлэ.
# sampleList = ["A", "B", "C", "D", "E"] жагсаалт үүсгэ. 
# Жагсаалтаас 1-ээс -3 хүртэлх индекстэй элементүүдийг таслан авч хэвлэ.
